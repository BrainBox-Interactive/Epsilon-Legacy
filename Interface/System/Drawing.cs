    ...
    public static class Drawing
    {
        ...
        public static void DrawButton(int x, int y, int width, int height, string content)
        {
            ...
            if (GUI.mx >= x
                ...
                && GUI.my <= y + height)
            {
                GUI.canv.DrawFilledRectangle(GUI.colors.btshColor, x + 1, y + 1, width - 1, height - 1);
                GUI.canv.DrawFilledRectangle(GUI.colors.bthColor, x + 1, y + 1, width - 2, height - 2);
            }
            else
            {
                GUI.canv.DrawFilledRectangle(GUI.colors.btsColor, x + 1, y + 1, width - 1, height - 1);
                GUI.canv.DrawFilledRectangle(GUI.colors.btColor, x + 1, y + 1, width - 2, height - 2);
            }
